    ...
    <>
      <ClientLayout>
        ...
        <div className="flex justify-center">
          <img src="/images/banner-dieu-khoan.png" alt="Banner Điều Khoản" />
        </div>

        <div className="grid grid-cols-[1fr_2fr] gap-10 justify-center mt-8">
          <article className="m-0">
            <div className="menu border border-gray-300 rounded-tl-[40px] rounded-br-[40px]">
              <p className="p-12">
                <a
          ...
          <aside className="mb-8">
            ...
            <br />
            <div className="text-base font-semibold">2.1 THẺ BẠC / SILVER</div>
            <br />
            <div className="text-lg font-semibold">ĐIỀU KIỆN</div>
            <br />
            <div className="font-xs text-[#6c757d]">
              Khách hàng có tổng giá trị hóa đơn từ: 12.000.000 VNĐ trong 01 năm
              kể từ ngày bắt đầu sử dụng thẻ
              <br />
              Điều kiện gia hạn thẻ: Khách hàng có tổng giá trị mua hàng từ
              12.000.000 VNĐ trong 01 năm tiếp theo sử dụng thẻ
              <br />
              Điều kiện nâng hạng thẻ VÀNG/GOLD MEMBERSHIP: Khách hàng có tổng
              giá trị mua hàng từ 23.000.00 VNĐ kể từ ngày đạt hạng thẻ
              BẠC/SILVER MEMBERSHIP
            </div>
            <br />
            ...
            <br />
            <div className="font-xs text-[#6c757d]">
              Khách hàng có tổng giá trị mua hàng từ 35.000.000 VNĐ trong 01 năm
              Hoặc Khách hàng có tổng giá trị mua hàng từ: 23.000.000 VNĐ trong
              vòng 01 năm kể từ ngày đạt hạng thẻ BẠC/SILVER MEMBERSHIP
              <br />
              Điều kiện gia hạn thẻ: Khách hàng có tổng giá trị mua hàng từ
              35.000.000 VNĐ trong 01 năm tiếp theo sử dụng thẻ
              <br />
              Điều kiện nâng hạng thẻ KIM CƯƠNG/DIAMOND MEMBERSHIP: Khách hàng
              có tổng giá trị mua hàng từ 25.000.000 VNĐ trong 01 năm kể từ ngày
              đạt hạng thẻ VÀNG/GOLD MEMBERSHIP
            </div>
            <br />
            <div className="text-lg font-semibold">QUYỀN LỢI</div>
            <br />
            ...
            <br />
            <div className="font-xs text-[#6c757d]">
              Khách hàng có tổng giá trị mua hàng từ 60.000.000 VNĐ trong 01 năm
              Hoặc Khách hàng có tổng giá trị mua hàng từ: 25.000.000 VNĐ trong
              vòng 01 năm kể từ ngày đạt hạng thẻ VÀNG/GOLD MEMBERSHIP
              <br />
              Điều kiện gia hạn thẻ: Khách hàng có tổng giá trị mua hàng từ
              60.000.000 VNĐ trong 01 năm kể từ ngày đạt hạng thẻ KIM
            ...
            <br />
            <div className="font-xs text-[#6c757d]">
              Thẻ có giá trị duy nhất đối với chủ thẻ. Không được phép sang
              nhượng hay cho mượn thẻ dưới mọi hình thức;
              <br />
              Vui lòng xuất trình thẻ khi thanh toán để tích lũy điểm và áp dụng
              chiết khấu của thẻ
              <br />
              Chiết khấu thẻ chỉ được áp dụng với hàng nguyên giá;
              <br />
              Điểm tích lũy của chủ thẻ (tương ứng với giá trị mua hàng) sẽ được
              quy đổi thành các phần quà có giá trị, duy trì và nâng hạng thẻ;
              <br />
              Thẻ có giá trị sử dụng trong vòng 01 năm kể từ ngày đăng ký, đạt
              hạng thẻ, gia hạn hoặc nâng hạng thẻ;
              <br />
            ...
            <br />
            <div className="text-lg font-semibold">4.1. MỤC ĐÍCH ÁP DỤNG</div>
            <br />
            <div className="font-xs text-[#6c757d]">
              Khi Khách Hàng thực hiện giao dịch và/hoặc đăng ký mở tài khoản
              tại Website và Ứng dụng, tùy từng thời điểm, Khách Hàng phải cung
            ...
            <div className="font-xs text-[#6c757d]">
              ...
              chống gian lận, điều tra, giải đáp thắc mắc…
              <br />
            ...
            <div className="font-xs text-[#6c757d]">
              ...
              Khách Hàng hoặc các hoạt động giả mạo nhận dạng của Khách Hàng
              trên Website và Ứng dụng;
              <br />
              Liên lạc, hỗ trợ liên lạc và giải quyết với Khách Hàng trong những
              trường hợp đặc biệt.
            </div>
            <br />
            <div className="text-base font-semibold">
